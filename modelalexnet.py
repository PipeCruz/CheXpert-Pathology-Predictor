...
BATCH_SIZE = 64
N_EPOCHS = 25  # Ensure this is set correctly
...
class MedicalImageClassifier(pl.LightningModule):
    def __init__(self):
        ...
        self.model.classifier[6] = nn.Linear(self.model.classifier[6].in_features, N_CLASSES)
...
def main(file_name="submission.csv", num_gpus=1):
    ...
    trainer = pl.Trainer(
        ...
        devices=num_gpus,
        strategy="ddp",
        max_epochs=N_EPOCHS,  # Ensure this is set correctly
