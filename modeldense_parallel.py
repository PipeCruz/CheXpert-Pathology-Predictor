...
def main(file_name="submission.csv", num_gpus=1, num_patient=100):
    ...
    model = MedicalImageClassifier.load_from_checkpoint("/home/ezhang3/156b/lightning_logs/version_2/checkpoints/epoch=73-step=51504.ckpt")

    # trainer = pl.Trainer(gpus=1 if torch.cuda.is_available() else 0, max_epochs=N_EPOCHS, distributed_backend='ddp')
    ...
    df = pd.DataFrame(predictions_all_batches)
